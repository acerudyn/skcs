    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                action="<?php $_SERVER['PHP_SELF']; ?>" target="_self" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                name="judul" id="tiga" required  value="<?php echo $myData[2]; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tiga" class="col-sm-2 control-label">Isi Berita</label>
                            <div class="col-sm-10">
                                <textarea class="form-control konten" placeholder="Isi Berita"
                                 name="konten" required ><?php echo $myData[3]; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
